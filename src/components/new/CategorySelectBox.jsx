...
export default function CategorySelectBox({ categoryData, setNewBreakdown, isSubmitted }) {
    ...
    const handleSetCategory = (e) => {
        const selectedCategory = categoryData.filter(data => data.category === e.target.value);
    ...
    const handleSetSubCategory = (e) => {
        const selectedSubCategory = category[0].sub_category.filter(data => data.name === e.target.value);
