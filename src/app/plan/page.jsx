...
const Page = () => {
    ...
    return (
        <>
            <Box sx={{display: {md: "flex"}, bgcolor: 'white', justifyContent: "space-between", padding: '1rem'}}>
                <Container>
                ...
                <SumBoard text={`Entire ${section == 'Expense' ? 'Budget' : 'Expected Income'}`} sumOfMoney={sumOfAmount} />
            </Box>
            <Box>
